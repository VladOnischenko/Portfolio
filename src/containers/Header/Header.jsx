...
const lightHeader = {
  background: ' url(./images/main-bg.jpg) center center / fill no-repeat fixed rgb(198, 108, 73, 0.3)',
}

const darkHeader = {
  background: ' url(./images/porto-night.jpeg) center center / fill no-repeat fixed rgb(198, 108, 73, 0.3)',
}
